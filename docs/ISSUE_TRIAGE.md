...
The main goal of issue triage is to categorize all incoming Terraform Module for Dell PowerScale issues and make sure each issue has all basic information needed for anyone else to understand and be able to start working on it.

> **Note:** This information is for Terraform Module for Dell PowerScale project Maintainers, Owners, and Admins. If you are a Contributor, then you will not be able to perform most of the tasks in this topic.

The core maintainers of the Terraform Module for Dell PowerScale project are responsible for categorizing all incoming issues and delegating any critical or important issue to other maintainers. Triage provides an important way to contribute to an open source project. 
...
- Terraform Module for Dell PowerScale version
- Bug description
- Expected behavior
- Logs
- Screenshots
- Platform & OS Terraform Module for Dell PowerScale is installed on

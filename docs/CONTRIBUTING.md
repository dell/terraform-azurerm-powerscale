...
* Contribute to the Terraform Module for Dell PowerScale documentation and codebase.
...
All issues related to Terraform Module for Dell PowerScale, should be submitted [here](https://github.com/dell/terraform-azurerm-powerscale/issues). Issues will be triaged and labels will be used to indicate the type of issue. This section outlines the types of issues that can be submitted.  

### Report bugs

We aim to track and document everything related to Terraform Module for Dell PowerScale via the Issues page. The code and documentation are released with no warranties or SLAs and are intended to be supported through a community driven process.

Before submitting a new issue, make sure someone hasn't already reported the problem. Look through the [existing issues](https://github.com/dell/terraform-azurerm-powerscale/issues) for similar issues.

Report a bug by submitting a [bug report](https://github.com/dell/terraform-azurerm-powerscale/issues/new?labels=type%2Fbug%2C+needs-triage&template=bug_report.md&title=%5BBUG%5D%3A). Make sure that you provide as much information as possible on how to reproduce the bug.
...
If you have an idea of how to improve this project, submit a [feature request](https://github.com/dell/terraform-azurerm-powerscale/issues/new?labels=type%2Ffeature-request%2C+needs-triage&template=feature_request.md&title=%5BFEATURE%5D%3A).

### Answering questions

If you have a question and you can't find the answer in the documentation or issues, the next step is to submit a [question.](https://github.com/dell/terraform-azurerm-powerscale/issues/new?labels=type%2Fquestion&template=ask-a-question.md&title=%5BQUESTION%5D%3A)

We'd love your help answering questions being asked by other Terraform Module for Dell PowerScale users.
...
If you don't have the knowledge or time to code, consider helping with _issue triage_. The Terraform Module for Dell PowerScale community will thank you for saving them time by spending some of yours.
...
* [Beginner-friendly](https://github.com/dell/terraform-azurerm-powerscale/issues?q=is%3Aopen+is%3Aissue+label%3A%22beginner+friendly%22) issues are generally straightforward to complete.
* [Help wanted](https://github.com/dell/terraform-azurerm-powerscale/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) issues are problems we would like the community to help us with regardless of complexity.
...
Terraform Module for Dell PowerScale uses the guidelines for commit messages outlined in [How to Write a Git Commit Message](https://chris.beams.io/posts/git-commit/)
